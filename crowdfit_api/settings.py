...
CROWDFIT_API_STATUS_REJECTED = 6

INVITATION_STATUS_INVITED = 1  # Invited
INVITATION_STATUS_CANCELED = 2  # Canceled
INVITATION_STATUS_REINVITED = 3  # Re-invited
INVITATION_STATUS_ACCEPTED = 4  # Accepted

INVITATION_STATUS_CHOICES = (
    (INVITATION_STATUS_INVITED, "Invited"),
    (INVITATION_STATUS_CANCELED, "Canceled"),
    (INVITATION_STATUS_REINVITED, "Re-invited"),
